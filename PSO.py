...
class PSO(SkoBase):
    ...
    def __init__(self, func, n_dim=None, pop=40, max_iter=150, lb=-1e5, ub=1e5, w=0.8, c1=0.5, c2=0.5,
        ...
        # 沿着第0轴(即列) 计算平均值。计算是的所有粒子的每一维度的平均值
    ...
    def update_V(self):
        ...
        self.V = self.w * self.V + \
                 ...
                 self.cg * r2 * (self.gbest_x - self.X)  # Broadcasting Numpy will replicate the array to fit the shape

    def update_X(self):
        self.X = self.X + self.V
        """
            it returns a new array where values of the original array below the minimum are set to the minimum, and
    ...
    def update_gbest(self):
        ...
        :return:
        """
        idx_min = self.pbest_y.argmin()  # The minimum value of the array(best image of every particle in history)
